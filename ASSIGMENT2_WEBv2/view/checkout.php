          ...
          <div class="row">
                ...
                <div class="list-group-item">
                  ...
                  <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea id="addr" name ="addr" class="form-control" placeholder="Type your address ...">
                        </textarea>
                      </div>
                    </div>
            ...
            <?php
              ...
              if (isset($_POST['submit']))
              {
                ...
                // get the form data
                $nameUser = htmlentities($_POST['nameUser'], ENT_QUOTES);
                ...
                if($check1&&$check6&&$check7&&$check8){
                  $sql = "INSERT INTO orders (fullname, email,phone,address,date_buy,total) 
                    VALUES ('$nameUser','$mail','$phone','$address','$time','$totalLast')";
                  $last_id=0;
